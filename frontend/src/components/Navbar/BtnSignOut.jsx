...
const BtnSignOut = () => {
  ...
  return (
    ...
    >
      <span className="w-6 flex justify-center mr-2"><LogoutIcon className="text-neutral-600 dark:text-gray-300 group-hover:text-segundaria-900 transition duration-300 ease-in-out" sx={{ width: 24 }} /></span>
