...
export default function Home() {
    return (
        <div className="w-full flex flex-col mx-auto dark:bg-bg">
            <header className="w-full flex flex-row items-center justify-between px-3 md:px-5 xl:px-20 pt-5">
                <div className="w-full flex justify-end lg:justify-normal flex-row-reverse lg:flex-row items-center lg:gap-4">
                    <div>
                        <h1 className='text-segundaria-900 dark:text-segundaria-900 text-3xl font-semibold'>OwnSystem</h1>
                    </div>
                    <Navbar />
                </div>
                ...
                <div className="flex w-full flex-row justify-end items-center gap-4">
                    <button className="hidden lg:flex bg-gray-50 hover:bg-gray-100 shadow-sm rounded-md px-3 py-1 transform hover:-translate-y-0.5 hover:scale-60 transition duration-500 ease-in-out">
                        <a
                            className="w-full text-neutral-700 dark:text-neutral-700 font-medium text-sm"
                        >
                            Teste Grátis
                        </a>
                    </button>
            ...
            <main className='w-full h-[880px] flex px-5 xl:px-20 py-5 lg:mt-20'>
                <div className='w-full md:w-1/2 flex flex-col items-start gap-6'>
                    <h3 className='text-6xl font-semibold dark:text-neutral-800'>
                        Transforme a <span className='text-segundaria-900 dark:text-segundaria-900'>Gestão do Seu Negócio</span> com Nosso Sistema Integrado
                    </h3>
                    <p className='md:w-[640px] font-medium dark:text-neutral-800'>
                    ...
                    <div>
                        ...
                        <button className="text-segundaria-800 dark:text-neutral-800 items-center text-lg font-medium rounded-md px-3 py-1 transform hover:-translate-y-0.5 hover:scale-60 transition duration-500 ease-in-out">
